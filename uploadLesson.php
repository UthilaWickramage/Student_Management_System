...
?>
    ...
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Teacher | Upload Lesson</title>
            ...
            <div class="row">
                <div class="col-10 offset-1">
                    <div class="card bg-light p-3 mt-3">
                        <div class="row mt-2">
                            <div class="col-12">
                                <h4 class="text-black-50">Upload Lesson Notes</h1>
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <select id="tsgid" class="form-select">
                                    <?php
                                    //teachers sujects will loaded by the teacher id
                                    ...
                                    if (!$scn > 0) { //if no of rows not larger than 0
                                    ?>
                                        <option>No subjects Available</option>
                                        <?php
                                    } else {
                                        for ($i = 0; $i < $scn; $i++) {//loop through rows
                                            $scd = $sc->fetch_assoc();// assoc array
                                        ?>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea id="desc" rows="10" class="form-control"></textarea>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12 d-grid">
                                <button class="btn btn-success" onclick="uploadLessons()">Upload Lesson Notes</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php
} else {//if the session does not belong to the teacher
?>
    <script>
